...
public class ItemSetMealVO {
    ...
    private List<ItemSetMeal> itemSetMealList;
    
    

    public List<ItemSetMeal> getItemSetMealList() {
		return itemSetMealList;
	}

	public void setItemSetMealList(List<ItemSetMeal> itemSetMealList) {
		this.itemSetMealList = itemSetMealList;
	}
