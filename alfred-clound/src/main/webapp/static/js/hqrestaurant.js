...
function fnFormatDetails(oTable, nTr) {
   ...
   // var tempAddress = aData[3] == null ? '' : aData[3];
    ...
    sOut +='<tr><td>'+jQuery.i18n.prop("restaurant.restaurantName")+':</td><td><input type="text" class="form-control small" name="restaurant" value="' + restaurant + '"></td>';
    sOut += '<td>'+jQuery.i18n.prop("restaurant.email")+':</td> <td><input type="email" name="email" class="form-control small" value="' + tempEmail + '"></td><td>'+jQuery.i18n.prop("restaurant.tel")+':</td><td><input type="text" name="tel" class="form-control small" value="' + tempTel + '"></td></tr>';
    sOut += '<tr><td>'+jQuery.i18n.prop("restaurant.address1")+':</td> <td><input type="text" class="form-control name="address1" small" value="' + tempAddress1 + '"></td>';
    sOut += '<td>'+jQuery.i18n.prop("restaurant.address2")+':</td> <td><input type="text" class="form-control small" value="' + tempAddress2 + '"></td><td>'+jQuery.i18n.prop("restaurant.postal")+':</td> <td><input type="text" class="form-control small"value="' + tempPostal + '"></tr>';
    sOut += '<tr><td>'+jQuery.i18n.prop("restaurant.country")+':</td> <td>'+contury+'</td>';
    sOut += '<td>'+jQuery.i18n.prop("restaurant.state")+':</td> <td>'+state+'</td><td>'+jQuery.i18n.prop("restaurant.city")+':</td> <td>'+city+'</td></tr>';
    sOut += '<tr><td>'+jQuery.i18n.prop("restaurant.des")+':</td> <td><input type="text" class="form-control small"value="' + tempDescription + '"></td><td>'+jQuery.i18n.prop("restaurant.type")+':</td><td>'+selectRes+'</td>';
    sOut += '<td><a class="edit" href=""><button type="button" data="' + temId + '" class="btn btn-info"><i class="fa fa-save"></i>'+jQuery.i18n.prop("restaurant.saveBut")+'</button></a></td></tr>';
...
$(document).ready(function () {
    ...
    nCloneTh.innerHTML =jQuery.i18n.prop("restaurant.edit");
	    	...
	    	if (id== '') {
	    		...
	    		$.ajax({
	    			...
	    			success : function(data) {
	        			if(data.flag==false){
	        				 bootbox.alert(jQuery.i18n.prop("restaurant.error.same"));
	        			     return ;
	        			}else{
	        	    		$.ajax({
	        	    			type : "post",
	        	    			...
	        	    			error : function() {
	        	    				bootbox.alert(jQuery.i18n.prop("restaurant.error.add"));
	        	    			}
	        	    		});
	    			...
	    			error : function() {
	    				bootbox.alert(jQuery.i18n.prop("restaurant.error.validation"));
	    			}
	    		});
	    			...
	    			success : function(data) {
	        			if(data.flag==false){
	        	    		...
	        	    		$.ajax({
	        	    			...
	        	    			error : function() {
	        	    				bootbox.alert(jQuery.i18n.prop("restaurant.error.modify"));
	        	    			}
	        	    		});
