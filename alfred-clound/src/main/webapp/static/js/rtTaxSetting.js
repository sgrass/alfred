        ...
        init: function () {
            function restoreRow(oTable, nRow) {
	            ...
	            oTable.fnUpdate(aData[6], nRow, 6, false);
 	        	oTable.fnUpdate('<a data="'+aData[0]+'" class="edit" href="">'+jQuery.i18n.prop("tax.edit")+'</a>', nRow, 7, false);
	            oTable.fnUpdate('<a data="'+aData[0]+'" class="delete" href="">'+jQuery.i18n.prop("tax.delete")+'</a>', nRow, 8, false);
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[4].innerHTML = '<a class="edit" data="'+aData[0]+'" href="">'+jQuery.i18n.prop("tax.edit")+'</a>';
                jqTds[5].innerHTML = '<a data="'+aData[0]+'" class="cancel" href="">'+jQuery.i18n.prop("tax.cancel")+'</a>';
            }
                ...
                if(check&&check1){
                	...
                	if (id== '') {
                		...
                		$.ajax({
                				...
                				$.ajax({
                	    			...
                	    			success : function(data) {   
                	    	        	...
                	    	        	oTable.fnUpdate(taxName, nRow, 3, false);
                 	    	        	...
                 	    	        	oTable.fnUpdate('<a data="'+data.flag+'" class="edit" href="">'+jQuery.i18n.prop("tax.edit")+'</a>', nRow, 7, false);
              	    	                oTable.fnUpdate('<a data="'+data.flag+'" class="delete" href="">'+jQuery.i18n.prop("tax.delete")+'</a>', nRow, 8, false);
              	    	               // oTable.fnDraw();
              	    	                addFlag=true;
                	    			...
                	    			error : function() {
                	    				bootbox.alert(jQuery.i18n.prop("tax.error.add"));
                	    			}
                	    		});
                			...
                			error : function() {
                				bootbox.alert(jQuery.i18n.prop("tax.error.validation"));
                			}
                		});
                	    				...
                	    				if(data.flag==0){
                	    				  ...
                	    				  $("#selectTax").html(taxlistdiv);
                    	    	        	...
                    	    	        	oTable.fnUpdate(taxName, nRow, 3, false);
                  	    	                ...
                  	    	                oTable.fnUpdate(typeName, nRow, 5, false);
                  	    	                oTable.fnUpdate(statusName, nRow, 6, false);
                  	    	          	    oTable.fnUpdate('<a data="'+id+'" class="edit" href="">'+jQuery.i18n.prop("tax.edit")+'</a>', nRow, 7, false);
              	    	                    oTable.fnUpdate('<a data="'+id+'" class="delete" href="">'+jQuery.i18n.prop("tax.delete")+'</a>', nRow, 8, false);
...
//            	"aaSorting": [[ 0, "asc" ]],
            ...
            $('#editable-sample_new').click(function (e) {
            	if(addFlag==true){
                      ...
                      var aiNew = oTable.fnAddData(['', '', '', '','','','',
                              '<a class="edit" href="">'+jQuery.i18n.prop("tax.edit")+'</a>', '<a class="cancel" data-mode="new" href="">'+jQuery.i18n.prop("tax.cancel")+'</a>'
                      ]);
            	    				...
            	    				if(data.flag==false){
                                    	...
                                    	$.ajax({
                                			...
                                			error : function() {
                                				...
                                				bootbox.alert(jQuery.i18n.prop("tax.error.delete"));
            	    					...
            	    					bootbox.alert(jQuery.i18n.prop("tax.error.same"));
            ...
            $('#editable-sample').on('click', "a.edit",function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    editRow(oTable, nRow);
                    nEditing = nRow;
                } else if (nEditing == nRow && this.innerHTML == jQuery.i18n.prop("tax.save")) {
