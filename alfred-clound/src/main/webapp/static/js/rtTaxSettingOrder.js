    ...
    return {
        ...
        init: function () {
            function restoreRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a data="'+oTable[0]+'" class="edit" href="">'+jQuery.i18n.prop("taxgroup.edit")+'</a>', nRow, 11, false);
                oTable.fnUpdate('<a data="'+oTable[0]+'" class="delete" href="">'+jQuery.i18n.prop("taxgroup.delete")+'</a>', nRow, 12, false);
            ...
            function editRow(oTable, nRow) {
                ...
                var  onTaxVal1="";
                onTaxVal1+='<option value="0">value</option><option value="1">'+jQuery.i18n.prop("taxgroup.tax1")+'</option>'
                
                var  onTaxVal2="";
                     onTaxVal2+='<option value="0">value</option><option value="1">'+jQuery.i18n.prop("taxgroup.tax1")+'</option><option value="2">'+jQuery.i18n.prop("taxgroup.tax2")+'</option>'	
                ...
                tax2+='<div class="col-md-5"><select id="tax2_'+editFlag+'" onchange="Tax2Select(this)" class="form-control" style="width:100px"><option value="">'+jQuery.i18n.prop("taxgroup.select")+'</option></select></div>';
                ...
                tax3+='<div class="col-md-5"><select id="tax3_'+editFlag+'" class="form-control" style="width:100px"><option value="">'+jQuery.i18n.prop("taxgroup.select")+'</option></select></div>';
                ...
                jqTds[4].innerHTML = '<a class="edit" href="">'+jQuery.i18n.prop("taxgroup.save")+'</a>';
                jqTds[5].innerHTML = '<a data="'+aData[0]+'" class="cancel" href="">'+jQuery.i18n.prop("taxgroup.cancel")+'</a>';
            ...
            function saveRow(oTable, nRow) {
                ...
                var tax2Name=taxNameObj[1].innerText== jQuery.i18n.prop("taxgroup.select") ? '' : taxNameObj[1].innerText;
                var tax2onId=taxIdOb[2].value
                var tax3Id=taxIdOb[3].value== '' ? 0 :taxIdOb[3].value;
                var tax3Name=taxNameObj[3].innerText== jQuery.i18n.prop("taxgroup.select") ? '' : taxNameObj[3].innerText;
            	...
            	if (taxGroupId== '') {
            				$.ajax({
            	    			...
            	    			error : function() {
            	    				bootbox.alert(jQuery.i18n.prop("taxgroup.error.add"));
            	    			}
            	    		});
    				...
    				$.ajax({
    	    			...
    	    			error : function() {
    	    				bootbox.alert(jQuery.i18n.prop("taxgroup.error.modify"));
    	    			}
    	    		});
            ...
            $('#editable-sample_new_order').click(function (e) {
            	if(addOrderFlag==true){
                     ...
                     var aiNew = oTable.fnAddData(['', '', '', '','','','','','','','',
                             '<a class="edit" href="">'+jQuery.i18n.prop("taxgroup.edit")+'</a>', '<a class="cancel" data-mode="new" href="">'+jQuery.i18n.prop("taxgroup.cancel")+'</a>'
                     ]);
                    ...
                    if (result) {
                    	...
                    	if(id==undefined){
                        	...
                        	$.ajax({
            	    			...
            	    			error : function() {
            	    				bootbox.alert(jQuery.i18n.prop("taxgroup.error.delete"));
            	    			}
            	    		});
            ...
            $('#editable-sample_order').on('click', "a.edit",function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    editRow(oTable, nRow);
                    nEditing = nRow;
                } else if (nEditing == nRow && this.innerHTML ==jQuery.i18n.prop("taxgroup.save")) {
...
function Tax1Select(v){
	   //$(v).prepend("<option value='111'>111111</option>");
	     ...
	     //找到下一个下拉框
	     $("#tax2_"+editFlag).append("<option value=''>"+jQuery.i18n.prop("taxgroup.select")+"</option>");
	     $("#tax3_"+editFlag).append("<option value=''>"+jQuery.i18n.prop("taxgroup.select")+"</option>");
	     $("#tax2_"+editFlag).append(optionHtml);
