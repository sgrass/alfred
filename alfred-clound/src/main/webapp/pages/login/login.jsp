...
<body class="login-body">
	...
	<div class="container">
		...
		<form id="loginForm" class="form-signin" method="post"
			...
			<h2 class="form-signin-heading"><spring:message code="login.head"></spring:message> </h2>
			<div class="login-wrap">
				...
				<label class="checkbox"> <input type="checkbox" name="remember" value="remember-me"> <spring:message code="login.remember"></spring:message> <span class="pull-right">
						<a data-toggle="modal" href="#myModal"> <spring:message code="login.forgor.password"></spring:message></a>
				</span>
				</label>
				<button class="btn btn-lg btn-login btn-block" type="submit"><spring:message code="login.button"></spring:message></button>
				<div class="registration">
					<spring:message code="login.is.register"></spring:message> <a class="" href="${contextPath}/company/forwardRegistration">
					<spring:message code="login.register"></spring:message> </a>
				</div>
			</div>
		</form>
