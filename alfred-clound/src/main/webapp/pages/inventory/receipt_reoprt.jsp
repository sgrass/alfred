				...
				<div class="col-sm-12">
			      ...
			      <div class="btn-group pull-right">
						...
						<div class="panel-body">
							...
							<div class="adv-table">
								<table class="display table table-bordered table-striped" id="receipt-table">
									<thead>
										<tr>
...
$(document).ready(function(){
    ...
    $(".dropdown-menu li").click(function(){
    	if($(this).text()=='Export PDF'){
        	...
        	$(".form-inline").attr("action","/materialStock/exportReceiptPdf");
        	$(".form-inline").submit();
        	...
        	$(".form-inline").attr("action","/materialStock/exportReceiptExcel");
        	$(".form-inline").submit();
    ...
    $("#materialStockReport").addClass("active");
	
    var oTable = $('#receipt-table').dataTable({
	        "bServerSide" : true,
			"sAjaxSource" : "/materialStock/ajaxReportMaterialReceipt",//mvc后台ajax调用接口。
			'bPaginate' : true,//是否分页。
			...
			"fnCreatedRow": function( nRow, aData, iDataIndex ) {
				//var dateFmt=new Date(parseInt(aData.businessDate)).format("MM-dd-yyyy");
	               $('td:eq(0)', nRow).html(moment(aData.createTime).format("MM-DD-YYYY"));
	 ...
	 function reflashTableList(){
         ...
         oSettings.sAjaxSource="/materialStock/ajaxReportMaterialReceipt";
