...
<section id="main-content">
	...
	<div style="display: none">
		<form id="material_stock_form"
			...
			<input id="stockQty" name="stockQty" type="hidden" value="" />
			<input id="stockTotalPrice" name="stockTotalPrice" type="hidden" value="" />
			<input id="materialName" name="materialName" type="hidden" value="" />
