				...
				<div class="col-sm-12">
			      ...
			      <div class="btn-group pull-right">
						...
						<div class="panel-body">
							...
							<div class="adv-table">
								<table class="display table table-bordered table-striped" id="hourly-table">
									<thead>
										<tr>
...
$(document).ready(function(){
    ...
    $(".dropdown-menu li").click(function(){
    	if($(this).text()=='Export PDF'){
        	...
        	$(".form-inline").attr("action","/reportHourly/exportHouryPdf");
        	$(".form-inline").submit();
        	...
        	$(".form-inline").attr("action","/reportHourly/exportHouryExcel");
        	$(".form-inline").submit();
    ...
    $("#hourlyli").addClass("active");
	
    var oTable = $('#hourly-table').dataTable({
	        "bServerSide" : true,
			"sAjaxSource" : "/reportHourly/ajaxReportHourly",//mvc后台ajax调用接口。
			'bPaginate' : true,//是否分页。
	 ...
	 function reflashTableList(){
         ...
         oSettings.sAjaxSource="/reportHourly/ajaxReportHourly";
