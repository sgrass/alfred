...
<head>
    ...
    <title>Item Discount Report</title>
...
$(document).ready(function(){
    ...
    $("#discountli").addClass("active");
    

    var oTable = $('#item-table').dataTable({
	        "bServerSide" : true,
			"sAjaxSource" : "/reportDiscount/ajaxOrderJson",//mvc后台ajax调用接口。
			'bPaginate' : true,//是否分页。
	 ...
	 function reflashTableList(){
         ...
         oSettings.sAjaxSource="/reportDiscount/ajaxOrderJson";
