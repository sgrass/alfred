        ...
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                <span>${order.subTotal }</span>
                 <spring:message code="dashboard.subTotal"></spring:message>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
               <span>${order.tax }</span>
                  <spring:message code="dashboard.totalTax"></spring:message>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                ...
                <spring:message code="dashboard.totalDiscount"></spring:message>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                ...
                <spring:message code="dashboard.totalAmount"></spring:message>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-8">
        ...
        <section class="panel">
            <header class="panel-heading">
                <spring:message code="dashboard.earning"></spring:message> <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-down"></a>
            <a href="javascript:;" class="fa fa-times"></a>
            </span>
            
            <div id="reportrange" style="cursor: pointer; height: 34px; width:306px;margin-top: -7px;padding: 6px 12px;font-size: 14px;line-height: 1.428571429;background-color: #fff;background-image: none;border: 1px solid #e2e2e4;box-shadow: none; color: #c2c2c2; border-radius: 4px;margin-right: 10px;" class="pull-right">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="region-earning-stats">
                             <div id="selectName">  <spring:message code="dashboard.day"></spring:message></div> <span id="revenueTotal"></span>
        ...
        <!--earning graph end-->
         ...
         <section class="panel">
                        <header class="panel-heading">
                         <spring:message code="dashboard.categoryTop"></spring:message>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-8 chartJS">
                              ...
                              <div class="col-md-4">
                                   ...
                                   <tr>
                                      <th></th>
                                      <th><spring:message code="dashboard.category"></spring:message></th>
                                      <th><spring:message code="dashboard.qty"></spring:message></th>
                                   </tr>
                                   </thead>
    ...
    <!--Session sales  start-->
	      <section class="panel">
	            <div class="panel-body">
	                <div class="top-stats-panel">
	                    <h4 class="widget-h"><spring:message code="dashboard.sessionSales"></spring:message></h4>
	                    ...
	                    <div class="bar-stats">
	                        ...
	                        <ul class="bar-legend">
	                            <li><span class="bar-legend-pointer pink"></span>  <spring:message code="dashboard.breakfast"></spring:message></li>
	                            <li><span class="bar-legend-pointer green"></span>  <spring:message code="dashboard.launch"></spring:message></li>
	                            <li><span class="bar-legend-pointer yellow-b"></span>  <spring:message code="dashboard.dinner"></spring:message></li>
	                        </ul>
	                        <div class="daily-sales-info">
	                            <span class="sales-count">$${sessionSales.total } </span> <span class="sales-label"><spring:message code="dashboard.netSales"></spring:message></span>
	                        </div>
	                    </div>
	                </div>
	            </div>
        ...
        <!-- Sales Settment -->
          <section class="panel">
            <div class="panel-body">
                <div class="top-stats-panel">
                    <h4 class="widget-h"><spring:message code="dashboard.daily"></spring:message></h4>
                    ...
                    <div class="bar-stats">
                        ...
                        <ul class="bar-legend">
                            <li><span class="bar-legend-pointer pink"></span>  <spring:message code="dashboard.cash"></spring:message></li>
                            <li><span class="bar-legend-pointer green"></span>  <spring:message code="dashboard.card"></spring:message></li>
                            <li><span class="bar-legend-pointer yellow-b"></span><spring:message code="dashboard.other"></spring:message></li>
                        </ul>
                        <div class="daily-sales-info">
                            <span class="sales-count">$${play.total}</span> <span class="sales-label"><spring:message code="dashboard.totalChecks"></spring:message></span>
                        </div>
                    </div>
                </div>
            </div>
