			...
			<div class="row">
						  ...
						  <div class="row" style="margin-left:5px;background: #D3D3D3;">
						          	<div class="btn-group">
											<button id="add_place__new" class="btn btn-primary">
												 <i class="fa fa-plus"></i><spring:message code="place.place"></spring:message>
											</button>
										</div>
						        </div>	
                ...
                <section class="panel">
                    <header class="panel-heading">
                     <div class="btn-group">
                                <spring:message code="place.addPlace"></spring:message>
                                </div>
                                <div class="btn-group pull-right">
                                     <button type="button" class="btn btn-success" id="addPlaceBut" style="margin-right:20px;"><i class="fa fa-save"></i> <spring:message code='table.save'></spring:message></button>
                                      <button type="button" class="btn btn-success" id="cancenPlaceBut">   <spring:message code='table.cancel'></spring:message></button>
                                </div>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                           <form id="addplacetablefrom">
                            <table id="addplacetable">
								<tbody>
									<tr class="gradeX">
										<td> <spring:message code='place.placesName'></spring:message></td>
										<td><input class=" form-control" name="placesName" type="text" required /></td>
									</tr>
									<tr class="gradeX">
										<td><spring:message code='place.placeDes'></spring:message></td>
										<td><input class=" form-control" name="placeDescription" type="text" /></td>
									</tr>
									<tr class="gradeX">
										<td><spring:message code='place.isActive'></spring:message></td>
                ...
                <section class="panel" id="placeaddtable_${place.id}" style="margin-top: 15px;">
                    ...
                    <div class="row">
                                ...
                                <div class=" pull-right">
                                     <button type="button" data='${place.id}'  dataRevenueId="${revenueId}" class="btn btn-primary" style="margin-right:20px;" id="editable-sample_new_${place.id}"><i class="fa fa-plus"></i><spring:message code="table.table"></spring:message></button>
                                     <button type="button" data='${place.id}' class="btn btn-success"><i class="fa fa-edit"></i>  <spring:message code="table.edit"></spring:message></button>
                                </div>
                    </div>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            <table class="table table-striped table-hover table-bordered" id="editable-sample_${place.id}">
                                ...
                                <tr>
                                    ...
                                    <th>placesId</th>
                                    <th>isActive</th>
                                    <th><spring:message code="table.tableName"></spring:message></th>
                                    <th><spring:message code="table.tablePacks"></spring:message></th>
                                    <th><spring:message code="table.isActive"></spring:message></th>
                                    <th><spring:message code="table.edit"></spring:message></th>
                                    <th><spring:message code="table.delete"></spring:message></th>
                                </tr>
                                </thead>
                                <tbody>
								...
								<td><a data="${table.id}" class="edit" href="javascript:;"><spring:message code="table.edit"></spring:message></a></td>
                                <td><a data="${table.id}" class="delete" href="javascript:;"><spring:message code="table.delete"></spring:message></a></td>
								</tr> 
								</c:if>
                                </c:forEach> 
                                </tbody>
                     ...
                     <div class="btn-group" style="text-transform: none;">
                               ${place.placeName}
                                ...
                                <div class="btn-group pull-right">
                                     ...
                                     <button type="button" data='${place.id}' class="btn btn-success editPlaceBut"  style="margin-right:20px"><i class="fa fa-save"></i>  <spring:message code="table.save"></spring:message></button>
                                      <button type="button" data='${place.id}' class="btn btn-success delPlaceBut"><i class="fa fa-trash-o"></i>  <spring:message code="table.delete"></spring:message></button>
                                </div>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            ...
                            <table id="place_${place.id}">
								<tbody>
									...
									<tr class="gradeX">
										<td><spring:message code="place.placeDes"></spring:message></td>
										<td><input class=" form-control" name="placeDescription" type="text" value="${place.placeDescription}"/></td>
									</tr>
									<tr class="gradeX">
										<td><spring:message code="place.isActive"></spring:message></td>
										<td><input type="checkbox" name="isActive" checked/></td>
