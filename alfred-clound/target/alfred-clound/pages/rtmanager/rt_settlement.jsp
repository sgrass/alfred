        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div style="text-transform: capitalize;">Settlement Settings
                    <span class="tools pull-right">
                        <button type="button" class="btn btn-success" id="saveBut"><i class="fa fa-save"></i>  Save</button>
                     </span>
                    </div>
                    </header>
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">General</label>
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                                <input type="checkbox" checked disabled="disabled" value="Cash">  cash
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                 
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Media</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Adjustments</label>
                        <div class="col-lg-3">
