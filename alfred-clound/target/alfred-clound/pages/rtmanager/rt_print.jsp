...
<section id="main-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                 <section class="panel">
                    <header class="panel-heading" style="height:67px"> 
                      <div style="text-transform: capitalize;">  Printer & KDS
                         <div class="btn-group pull-right">
                                     <button id="editable-sample_new" class="btn btn-primary">
                                     <i class="fa fa-plus"></i>  Printer 
                                    </button>
                                </div>
                        </div>        
                    </header>
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
								...
								<td><a data="${printer.id}" class="edit" href="javascript:;">Edit</a></td>
                                <td><a data="${printer.id}" class="delete" href="javascript:;">Delete</a></td>
								</tr> 
                                </c:forEach> 
                                </tbody>
                            </table>
            ...
            <div class="col-sm-12">
                 <section class="panel">
                    <header class="panel-heading" style="height:67px"> 
                      <div style="text-transform: capitalize;">  Printer Group
                         <div class="btn-group pull-right">
                                     <button id="editable-sample_new_order" class="btn btn-primary">
                                     <i class="fa fa-plus"></i>  Printer Group 
                                    </button>
                                </div>
                        </div>        
                    </header>
                    <div class="panel-body">
                        <div class="adv-table editable-table " id="taxRuleTable">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="printer_group_edit">
								...
								<td><a data="${printerGroup.id}" class="edit" href="javascript:;">Edit</a></td>
                                <td><a data="${printerGroup.id}" class="delete" href="javascript:;">Delete</a></td>
								</tr> 
                                </c:forEach> 
                                </tbody>
                            </table>
