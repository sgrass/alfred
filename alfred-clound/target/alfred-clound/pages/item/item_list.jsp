             	...
             	<div class="panel-body">
                        <form id="fileupload" action="${contextPath}/importExcel/importItems" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                                <label class="control-label col-md-3">Import Items Excel(.xlsx/.xls) </label>
                                <div class="col-md-4">
				...
				<div class="col-sm-12">
                    ...
                    <header class="panel-heading" style="height:67px"> 
							...
							<div class="btn-group pull-right">
								<button id="editable-sample_new" class="btn btn-primary" onclick="addItemDetail(true)"><i class="fa fa-plus"></i> Item</button>
							</div>
							</div>
						</header>
						<div class="panel-body">
												...
												<table border="0" width="100%">
													...
													<tr>
														<td colspan="8" align="center">
															<input type="button" id="form_add" class="btn btn-info " value="Save" /> 
											...
											<td colspan="6" class="details">
												<form id="form${i.index}" action="${contextPath}/item/updateById" method="post" enctype="multipart/form-data">
													...
													<table border="0" width="100%">
														...
														<tr>
															<td colspan="8" align="center">
																<input type="button"  data="${i.index}" class="btn btn-info  updateClass" value="Save" />
