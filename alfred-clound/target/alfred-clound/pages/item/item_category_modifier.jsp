								...
								<tbody>
									<c:forEach var="ic" items="${imc.itemCategoryList}" varStatus="j">
										<tr>
											...
											<td>
												<div id="save${i.index}${j.index}" style="display:none"><a class="edit" href="javascript:;" onclick="saveCateModifier(${ic.id},'${i.index}${j.index}')">Save</a></div>
											</td>
											<td>
												<a class="edit" href="${contextPath}/itemModifier/queryItemModifier?itemMainCategoryId=${imc.id}&itemCategoryId=${ic.id}">editDetail</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
