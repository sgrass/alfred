				...
				<div class="col-sm-12">
			      ...
			      <div class="btn-group pull-right">
						...
						<div class="panel-body">
							...
							<div class="adv-table">
								<table class="display table table-bordered table-striped" id="order-table">
									<thead>
										<tr>
...
$(document).ready(function(){
    ...
    $(".dropdown-menu li").click(function(){
    	if($(this).text()=='Export PDF'){
        	...
        	$(".form-inline").attr("action","/orderDetail/exportOrderListPdf");
        	$(".form-inline").submit();
    		...
    		$("#startTime").val($('input[name="daterangepicker_start"]').val());
    		$("#endTime").val( $('input[name="daterangepicker_end"]').val());
        	$(".form-inline").attr("action","/orderDetail/exportOrderList");
        	$(".form-inline").submit();
    ...
    $("#orderlistli").addClass("active");
    
    var oTable = $('#order-table').dataTable({
        "bServerSide" : true,
		"sAjaxSource" : "/orderDetail/ajaxOrderDetailJson",//mvc后台ajax调用接口。
		'bPaginate' : true,//是否分页。
 ...
 function reflashTableList(){
     ...
     oSettings.sAjaxSource="/orderDetail/ajaxOrderDetailJson";
