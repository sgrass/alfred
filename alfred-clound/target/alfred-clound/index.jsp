    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${staticPath}/images/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${staticPath}/images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="${staticPath}/images/avatar-mini-3.jpg"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="${staticPath}/images/avatar1_small.jpg">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="#">Fashion District</a>i</li>

                        <li><a href="#">Grand Central</a></li>
                        ...
                        <li><a href="#">Gramercy</a></li>

                        <li><a href="#">Financial District</a></li>

                        <li><a href="#">Let&amp;apos;s Pizza</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="#">Menu Item Reports</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="#">Open Checks</a></li>
                        <li><a href="#">Clocked In Employees</a></li>
                        <li><a href="#">Unfinalized Tip Viewer</a></li>
                        <li><a href="#">Run End of Day</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="#">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="#">Enterprise Budget</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="#">Check Viewer</a></li>
                        <li><a href="#">Timecard Editor</a></li>
                        <li><a href="#">CC Transaction</a></li>
                        <li><a href="#">AuditTrail Viewer</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="line-chart">
                            <div class="sparkline" data-type="line" data-resize="true" data-height="75" data-width="90%"
                                 data-line-width="1" data-min-spot-color="false" data-max-spot-color="false"
                                 data-line-color="#ffffff" data-spot-color="#ffffff" data-fill-color=""
                                 data-highlight-line-color="#ffffff" data-highlight-spot-color="#e1b8ff"
                                 data-spot-radius="3" data-data="[100,200,459,234,600,800,345,987,675,457,765]">
                            </div>
                        </div>
                        <div class="tab-pane" id="bar-chart">
                            <div class="sparkline" data-type="bar" data-resize="true" data-height="75" data-width="90%"
                                 data-bar-color="#d4a7f5" data-bar-width="10"
        ...
        <section class="panel">
            <div class="panel-body">
                <ul class="clearfix prospective-spark-bar">
                    ...
                    <li class="pull-right">
                        <div class="sparkline" data-type="bar" data-resize="true" data-height="40" data-width="90%"
                             data-bar-color="#f6b0ae" data-bar-width="5"
                             data-data="[300,200,500,700,654,987,457,300,876,454,788,300,200,500,700,654,987,457,300,876,454,788]"></div>
                    </li>
                </ul>
            </div>
        ...
        <div class="event-calendar clearfix">
            ...
            <div class="col-lg-5 event-list-block">
                ...
                <ul class="event-list">
                    ...
                    <li>Coffee meeting with Lisa @ 4:30 <a href="#" class="event-close"><i class="ico-close2"></i></a>
                    </li>
                    <li>Skypee conf with patrick @ 5:45 <a href="#" class="event-close"><i class="ico-close2"></i></a>
                    </li>
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="${staticPath}/images/chat-user-thumb.png" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="${staticPath}/images/chat-user-thumb-f.png" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="${staticPath}/images/weather_image.jpg" height="243" alt="">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="alert alert-info clearfix">
                ...
                <div class="notification-info">
                    <ul class="clearfix notification-meta">
                        <li class="pull-left notification-sender"><span><a href="#">Jonathan Smith</a></span> send you a
                            mail
                        </li>
            ...
            <div class="alert alert-danger">
                ...
                <div class="notification-info">
                    <ul class="clearfix notification-meta">
                        <li class="pull-left notification-sender"><span><a href="#">Jonathan Smith</a></span> mentioned
                            you in a post
                        </li>
            ...
            <div class="todo-action-bar">
                <div class="row">
                    ...
                    <div class="col-xs-4 btn-add-task">
                        <button type="submit" class="btn btn-default btn-primary"><i class="fa fa-plus"></i> Add Task
                        </button>
                    </div>
                </div>
            </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${staticPath}/images/avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${staticPath}/images/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="${staticPath}/images/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
...
<!--jQuery Flot Chart-->
<script src="${staticPath}/js/flot-chart/jquery.flot.js"></script>
<script src="${staticPath}/js/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="${staticPath}/js/flot-chart/jquery.flot.resize.js"></script>
<script src="${staticPath}/js/flot-chart/jquery.flot.pie.resize.js"></script>
<script src="${staticPath}/js/flot-chart/jquery.flot.animator.min.js"></script>
<script src="${staticPath}/js/flot-chart/jquery.flot.growraf.js"></script>
