                		...
                		$.ajax({
        	    			...
        	    			success : function(data) {
        	    				if(data.flag==false){
        	    					 ...
        	    					 addFlag=true;
        	    					 bootbox.alert('The table name already exists, please change!');
        	    					 return ;
        	    				}else{
                    	    			...
                    	    			success : function(data, index) {
                    	    				...
                    	    				if(data.flag==0){
                    	    					...
                    	    					oTable.fnUpdate(placesId, nRow, 2, false);
                     	    	                ...
                     	    	                oTable.fnUpdate(tablePacks, nRow, 5, false);
                     	    	                oTable.fnUpdate(isActivetem, nRow, 6, false);
                    	    	                oTable.fnUpdate('<a class="edit" data="'+data.flag+'" href="">Edit</a>', nRow, 7, false);
                    	    	                oTable.fnUpdate('<a class="delete" data="'+data.flag+'" href="">Delete</a>', nRow, 8, false);
                    	    	                //oTable.fnDraw();
                    	    	                addFlag=true;
                    	    	        		//location.reload();
                    	    					//alert('修改成功！');
		...
		if(check){
			...
			$.ajax({
				...
				if(data.flag==false){
					 ...
					 bootbox.alert('The name has been exist, please change!');
