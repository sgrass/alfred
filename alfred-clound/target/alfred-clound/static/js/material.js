    ...
    return {
         init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[2].innerHTML = '<form id="form_quantityMin_'+aData[0]+'"><input  type="text" class="form-control small"  value="' + aData[3] + '" required></form>';
                jqTds[3].innerHTML = '<form id="form_quantityCurrent_'+aData[0]+'"><input  type="text" class="form-control small"  value="' + aData[4] + '" required></form>';
