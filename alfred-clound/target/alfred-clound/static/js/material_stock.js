    ...
    return {
         init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[2].innerHTML = '<form id="form_stockQty_'+aData[0]+'"><input  type="text" class="form-control small"  value="' + aData[3] + '" required></form>';
                jqTds[3].innerHTML = '<form id="form_stockTotalPrice_'+aData[0]+'"><input  data1="'+aData[5]+'" data2="'+aData[6]+'" type="text" class="form-control small"  value="' + aData[4] + '" required></form>';
