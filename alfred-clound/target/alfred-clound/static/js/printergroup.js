    ...
    return {
        init: function () {
            function restoreRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a data="'+aData[0]+'" class="edit" href="">Edit</a>', nRow, 4, false);
                oTable.fnUpdate('<a data="'+aData[0]+'" class="delete" href="">Delete</a>', nRow, 5, false);
                oTable.fnDraw();
            }
            function editRow(oTable, nRow) {
                ...
                jqTds[2].innerHTML = '<a class="edit" data="'+aData[0]+'" href="">Save</a>';
                jqTds[3].innerHTML = '<a data="'+aData[0]+'" class="cancel" href="">Cancel</a>';
                //下拉
            	    			...
            	    			success : function(data) {
            	    				if(data.flag!=0){
            	    					...
            	    					oTable.fnUpdate(data.flag, nRow, 0, false);
              	    	        	    ...
              	    	        	    oTable.fnUpdate('<a data="'+data.flag+'" class="edit" href="">Edit</a>', nRow, 4, false);
            	    	                oTable.fnUpdate('<a data="'+data.flag+'" class="delete" href="">Delete</a>', nRow, 5, false);
                      	                //oTable.fnDraw();
            	    				}
    	    			...
    	    			success : function(data) {
    	    				...
    	    				if(data.flag==0){
    	    					...
    	    					oTable.fnUpdate(id, nRow, 0, false);
              	                ...
              	                oTable.fnUpdate(groupName, nRow, 2, false);
              	                oTable.fnUpdate(textVal, nRow, 3, false);
      	    	        	    oTable.fnUpdate('<a data="'+id+'" class="edit" href="">Edit</a>', nRow, 4, false);
    	    	                oTable.fnUpdate('<a data="'+id+'" class="delete" href="">Delete</a>', nRow, 5, false);
              	                //oTable.fnDraw();
    	    				}
